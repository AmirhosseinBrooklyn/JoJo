...
const val LICENSE = """JoJo | A modern, free, and secure Android client based on the SagerNet UI, powered by the sing-box core, optimized for Iran users
Developed by Brooklyn
With sincere thanks and appreciation to Victoria and the Husi team

This program is free software and a fork of the Husi client.
All copyrights of the original work remain with their respective authors and this project is distributed under the same license.

You may use, redistribute and/or modify this program under the terms of the GNU General Public License (GPL) version 3 or any later version published by the Free Software Foundation.
This program is distributed in the hope that it will be useful, especially for Iran users, but WITHOUT ANY WARRANTY;
without even the implied warranty of MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, SECURITY, or NON-MISUSE.
